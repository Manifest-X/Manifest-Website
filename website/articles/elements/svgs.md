...
The SVG tag itself can be applied within apostrophes, using `&quot;` for its internal double quotes. However this is redundant when the SVG is more easily placed directly as inline HTML.
